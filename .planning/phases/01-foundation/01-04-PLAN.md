...
must_haves:
  truths:
    ...
    - "Installer size is under 15 MB"
    - "WebView2 downloadBootstrapper mode is configured"
  artifacts:
...
- Installer size under 15 MB (DIST-02)
- WebView2 downloadBootstrapper configured (from tauri.conf.json)
</success_criteria>
